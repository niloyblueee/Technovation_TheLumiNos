...
import { FaArrowLeft, FaCheckCircle, FaClock, FaExclamationTriangle, FaMapMarkerAlt } from 'react-icons/fa';
import { MapContainer, Marker, TileLayer } from 'react-leaflet';
import L from 'leaflet';
import 'leaflet/dist/leaflet.css';
import styles from './PoliceIssueDetails.module.css';
...
const PoliceIssueDetails = () => {
    ...
    const fetchIssue = useCallback(async () => {
        ...
        try {
            ...
            if (!departments.includes('police')) {
                toast.error('This incident is not assigned to the police department.');
    ...
    return (
        <div className={styles.wrapper}>
            ...
            >
                ...
                >
                    <FaCheckCircle /> {issue.status === 'resolved' ? 'Already Resolved' : resolving ? 'Resolving...' : 'Mark as Resolved'}
                </button>
            </motion.footer>
        </div>
    );
...
export default PoliceIssueDetails;
