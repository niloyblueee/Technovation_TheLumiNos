...
import { FaArrowLeft, FaCheckCircle, FaClinicMedical, FaClock, FaExclamationTriangle, FaMapMarkerAlt } from 'react-icons/fa';
import { MapContainer, Marker, TileLayer } from 'react-leaflet';
import L from 'leaflet';
import 'leaflet/dist/leaflet.css';
import styles from './HealthIssueDetails.module.css';
...
const HealthIssueDetails = () => {
    ...
    const fetchIssue = useCallback(async () => {
        ...
        try {
            ...
            if (!departments.includes('health')) {
                toast.error('This incident is not assigned to the health department.');
            ...
            console.error('Failed to load health issue details', err);
    ...
    const handleResolve = async () => {
        ...
        try {
            ...
            toast.success(`Incident #${issue.id} marked as stabilized.`);
            navigate('/health', { replace: true });
        } catch (err) {
    ...
    return (
        <div className={styles.wrapper}>
                ...
                <div className={styles.contentGrid}>
                    ...
                    {issue.photo ? (
                        <div className={styles.mediaSection}>
                            <h2><FaClinicMedical /> Evidence Snapshot</h2>
            ...
            >
                ...
                >
                    <FaCheckCircle /> {issue.status === 'resolved' ? 'Already Stabilized' : resolving ? 'Marking...' : 'Mark as Stabilized'}
                </button>
            </motion.footer>
        </div>
    );
