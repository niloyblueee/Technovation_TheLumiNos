...
import { FaArrowLeft, FaCheckCircle, FaClock, FaExclamationTriangle, FaTint, FaMapMarkerAlt } from 'react-icons/fa';
import { MapContainer, Marker, TileLayer } from 'react-leaflet';
import L from 'leaflet';
import 'leaflet/dist/leaflet.css';
import styles from './WaterIssueDetails.module.css';
...
const WaterIssueDetails = () => {
    ...
    const fetchIssue = useCallback(async () => {
        ...
        try {
            ...
            if (!departments.includes('water')) {
                toast.error('This incident is not assigned to the water department.');
            ...
            console.error('Failed to load water issue details', err);
    ...
    const handleResolve = async () => {
        ...
        try {
            ...
            toast.success(`Incident #${issue.id} marked as resolved.`);
            navigate('/water', { replace: true });
        } catch (err) {
    ...
    return (
        <div className={styles.wrapper}>
                ...
                <div className={styles.contentGrid}>
                    ...
                    {issue.photo ? (
                        <div className={styles.mediaSection}>
                            <h2><FaTint /> Evidence Snapshot</h2>
            ...
            >
                ...
                >
                    <FaCheckCircle /> {issue.status === 'resolved' ? 'Already Resolved' : resolving ? 'Marking...' : 'Mark as Resolved'}
                </button>
            </motion.footer>
        </div>
    );
...
export default WaterIssueDetails;
