...
import { FaArrowLeft, FaBolt, FaCheckCircle, FaClock, FaExclamationTriangle, FaMapMarkerAlt, FaPlug } from 'react-icons/fa';
import { MapContainer, Marker, TileLayer } from 'react-leaflet';
import L from 'leaflet';
import 'leaflet/dist/leaflet.css';
import styles from './ElectricityIssueDetails.module.css';
...
const ElectricityIssueDetails = () => {
    ...
    const fetchIssue = useCallback(async () => {
        ...
        try {
            ...
            if (!departments.includes('electricity')) {
                toast.error('This incident is not assigned to the electricity department.');
            ...
            console.error('Failed to load electricity issue details', err);
    ...
    const handleResolve = async () => {
        ...
        try {
            ...
            toast.success(`Incident #${issue.id} marked as restored.`);
            navigate('/electricity', { replace: true });
        } catch (err) {
    ...
    return (
        <div className={styles.wrapper}>
                ...
                <div className={styles.contentGrid}>
                    ...
                    {issue.photo ? (
                        <div className={styles.mediaSection}>
                            <h2><FaPlug /> Evidence Snapshot</h2>
            ...
            >
                ...
                >
                    <FaCheckCircle /> {issue.status === 'resolved' ? 'Already Restored' : resolving ? 'Marking...' : 'Mark as Restored'}
                </button>
            </motion.footer>
        </div>
    );
...
export default ElectricityIssueDetails;
